...
export const StyledButton = React.forwardRef<HTMLButtonElement, any>(
  ({ className, ...props }, ref) => {
    return (
      <motion.button
        className="mb-2 border-b relative text-black dark:text-white border-blue-400 w-full h-20 flex justify-center items-center hover:pl-3 hover:bg-[#0B2762]/[0.24] md:w-fit md:h-fit
