...
export const SwitchContainer = styled.div<ISwitchContainer>`
  position: relative;
  height: ${(props) =>
    props.size % 2 === 1 ? props.size + 0.1 : props.size}px;
  width: ${(props) =>
    (props.size * 2.5) % 2 === 1 ? props.size * 2.5 + 1 : props.size * 2.5}px;
`;
...
export const Switch: any = styled.div<ISwitch>`
  ...
  border-radius: 70px;
  border: 5px solid
    ${(props) => (props.checked ? "rgb(40, 40, 51)" : "rgb(211, 239, 255)")};
  background-color: ${(props) =>
    props.checked ? "rgb(23, 23, 35)" : "rgb(186, 230, 255)"};
  transition: border-color 1500ms, background-color 1500ms, box-shadow 1500ms;
  ${(props) =>
    props.shadows &&
    `box-shadow: 0 0 35px 1px ${props.checked ? "#E0E0E0" : "#616161"};`}
    ...
    css`
      ...
      ${Stars} {
        & ${Star} {
          &:nth-of-type(1) {
            animation: ${css`
              ${startravel1} 7.5s linear infinite
            `};
            animation-delay: 0.2s;
          }
          &:nth-of-type(2) {
            animation: ${css`
              ${startravel2} 6s linear infinite
            `};
            animation-delay: 0.1s;
          }
          &:nth-of-type(3) {
            animation: ${css`
              ${startravel3} 9s linear infinite
            `};
            animation-delay: 0s;
          }
        }
      ...
      ${ShootingStarWrapper} {
        ...
        animation: ${css`
          ${shootingstartravel} 12s linear infinite
        `};
        animation-delay: 3s;
      }
      ${ShootingStar} {
...
export const Circle = styled.div`
  ...
  box-shadow: 0 0 20px 10px rgb(255, 233, 183), 0 0 40px 30px rgb(255, 219, 140),
    0 0 90px 50px rgb(255, 209, 109);
  transition: left 1s, transform 1s, width 1s, height 1s, box-shadow 1s,
    background-color 1s 0.1s;
  z-index: 1;
...
export const Star = styled.div`
  ...
  &::after {
    ...
    animation: ${css`
      ${growbrighter} 0.5s linear alternate infinite
    `};
    left: 50%;
    top: 50%;
  }
...
export const ShootingStar = styled.div`
  ...
  box-shadow: -5px 0 20px 2px rgba(237, 155, 61, 0.7),
...
export const Cloud = styled.div`
  ...
  &:nth-of-type(1) {
    ...
    top: 5px;
    animation: ${css`
      ${cloudtravel1} 11s linear infinite
    `};
  ...
  &:nth-of-type(2) {
    ...
    top: 26px;
    animation: ${css`
      ${cloudtravel2} 9s linear infinite
    `};
  ...
  &:nth-of-type(3) {
    ...
    top: 48px;
    animation: ${css`
      ${cloudtravel3} 15s linear infinite
    `};
