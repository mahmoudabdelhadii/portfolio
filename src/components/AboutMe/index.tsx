...
const AboutMe: React.FunctionComponent<any> = () => {
  return (
    <ParticleRing>
      <div className="absolute flex flex-col p-0 items-center justify-center min-h-screen h-max md:items-center top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] md:justify-center md:h-fit md:min-h-fit md:w-full pointer-events-none">
