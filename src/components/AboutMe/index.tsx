...
const AboutMe: React.FunctionComponent<any> = () => {
  return (
    <ParticleRing>
      <div className="absolute flex flex-col p-0 items-center justify-center min-h-screen h-max md:items-center absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] md:justify-center md:h-fit md:min-h-fit md:w-full pointer-events-none">
          ...
          <div className="w-5/6 flex flex-col justify-center items-center gap-4 md:w-full md:flex-row md:justify-between md:items-center z-10">
            ...
            <div className="flex flex-col w-5/6 md:basis-1/2">
              ...
              >
                ...
                Major Entrance Scholarship. I have a strong interest and skill
                in software development, security engineering, systems
